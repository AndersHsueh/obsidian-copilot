# Contributing to Obsidian-Mate

First off, thank you for considering contributing to Obsidian-Mate! It's people like you who make Obsidian-Mate such a great tool!
...
Unsure where to begin contributing to Obsidian-Mate? You can start by looking through the `help-wanted` issues.

### Pull Requests

The process described here aims to:

- Maintain the quality of Obsidian-Mate.
- Fix problems that are important to users.
- Engage the community in working towards the best possible Obsidian-Mate.
- Enable a sustainable system for Obsidian-Mate's maintainers to review contributions.
...
In the case of Obsidian-Mate, you will need to:
...
- Use the "Refresh index" button and see if it properly starts indexing. If it says "index is up-to-date", use "Clear Obsidian-Mate index" and start indexing again (or equivalently, use "force re-index" command).
...
- **Discord**: [Join](https://discord.gg/bFtfKDQqZt) the server for Obsidian-Mate dev discussions.
- **Email**: logan@brevilabs.com

Thank you for contributing to Obsidian-Mate!
